...
for i, box in enumerate(grid):
    ...
    if np.isnan(perigosidade):
        perigosidade = 0
    texto = 'A média de criminosos é de: {}; A média de perigosidade é de: {};O n.º de ataques que ocorreram na região é de: {}; O nível de ataque médio da região é de: {}; ggg:{}'.format(str(criminosos)
                                                                                                              ,str(perigosidade),
                                                                                                              str(n_ataques),
                                                                                                              str(nivel),
                                                                                                              str(grid_coord[i]))
...
title = 'Mapa de calor com grelha {0} desde {1}'.format('risco',in_ano)
title_html = '''
