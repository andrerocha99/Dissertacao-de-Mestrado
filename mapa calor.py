...
#ataques = ataques[ataques.Ano.isin([in_ano])]  #quando se quer apenas para 1 ano especifico
...
max_nivel = 1.75 #permite alterar o quão vermelho e o quanto queremos dar destaque à pintura, se diminuir muito o valor as cores ficam muito parecidas
...
title = 'Mapa de calor com grelha de {0} desde {1} até {2}'.format('risco',2010,2021)
title_html = '''
...
m.save('Mapa calor com clusters.html')