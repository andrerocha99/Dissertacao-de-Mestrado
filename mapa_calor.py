...
for box in grid:
    ...
    if np.isnan(perigosidade):
        perigosidade = 0
    texto = 'média de criminosos: {}; média de perigosidade: {}; n.º de ataques: {}'.format(str(criminosos),str(perigosidade),str(n_ataques))
...
for i, box in enumerate(grid):
    ...
    color = plt.cm.Reds(counts[i]/max_ataques)
