...
ataques = ataques[ataques.Ano.isin([kik_ano,jul_ano])]  #quando se quer apenas para 1 ano especifico
...
title = 'Mapa de calor com grelha de {0} desde {1} até {2}'.format('risco',in_ano,jul_ano)
title_html = '''
...
m.save('nivel ataque 2019 a 2020.html')