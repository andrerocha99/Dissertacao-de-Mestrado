...
max_nivel = 5 #permite alterar o quão vermelho e o quanto queremos dar destaque à pintura, se diminuir muito o valor as cores ficam muito parecidas
...
title = 'Mapa de calor com grelha de {0} desde {1} até {2}'.format('risco',in_ano,out_ano)
title_html = '''
...
m.save('numero_criminosos_2010 a 2015.html')
